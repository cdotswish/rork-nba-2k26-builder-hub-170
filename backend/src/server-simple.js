...
app.put('/api/auth/profile', authenticateToken, (req, res) => {
  try {
    console.log('Profile update attempt:', { userId: req.user.userId, body: req.body });
    ...
    console.log('Profile updated successfully:', { id: users[userIndex].id, name: users[userIndex].name });
...
app.get('/api/builds', optionalAuth, (req, res) => {
  try {
    console.log('Fetching builds, total:', builds.length);
...
app.post('/api/builds', authenticateToken, (req, res) => {
  try {
    console.log('Creating build:', { userId: req.user.userId, body: req.body });
    ...
    builds.push(build);
    console.log('Build created successfully:', { id: build.id, name: build.name, totalBuilds: builds.length });
...
app.put('/api/builds/:id', authenticateToken, (req, res) => {
  try {
    ...
    console.log('Build updated successfully:', { id: buildId });
...
app.delete('/api/builds/:id', authenticateToken, (req, res) => {
  try {
    ...
    console.log('Build deleted successfully:', { id: buildId });
...
app.get('/api/reviews', optionalAuth, (req, res) => {
  try {
    console.log('Fetching reviews, total:', reviews.length);
...
app.post('/api/reviews', authenticateToken, (req, res) => {
  try {
    console.log('Creating review:', { userId: req.user.userId, body: req.body });
    ...
    console.log('Review created successfully:', { id: review.id, buildId, rating });
